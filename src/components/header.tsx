...
import { navbars } from "@/constants/navbars.constant";
                                ...
                                return (
                                    ...
                                    >
                                        <Link
                                            ...
                                            href={navbar.href}
                                            className={`group relative font-medium transition-all duration-300 flex items-center gap-1 text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white`}
                                            onClick={closeMenu}
                                        >
                                    ...
                                    return (
                                        ...
                                        >
                                            <Link
                                                ...
                                                href={navbar.href}
                                                onClick={closeMenu}
                                                className={`relative font-semibold text-xl transition-all duration-300 flex items-center gap-2 py-3 px-4 rounded text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white hover:bg-gray-100 dark:hover:bg-slate-800/50`}
                                            >
                                                <motion.span
